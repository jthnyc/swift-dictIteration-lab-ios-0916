 ...
 */
topSellingAlbum["Pixie"] = "Doolittle"
print(topSellingAlbum)
...
var nirvAlbum = topSellingAlbum[bandName]

if var nirvAlbum = nirvAlbum {
    print ("\(bandName)'s top-selling album was \(nirvAlbum)")
}
 ...
 */
for (band, album) in topSellingAlbum {
    print ("\(band)'s top-selling albumm was \(album)")
}
 ...
 */
// key and value. key being the grade, and value being the letter grade result.
